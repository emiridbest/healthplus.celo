...
export default function SendToNumberModal({
  ...
  async function send() {
    ...
    const amountToSend = toWei(sendAmount.toString()); // Convert sendAmount to Wei
  
    await sendToNumber(number, amountToSend);
  ...
  return (
    <Modal isOpen={isOpen} style={customStyles}>
      {activeIndex === 0 ? (
        <div className="">
          <div className="p-20">
            <h2 className="py-5">Hospital phone number</h2>
            <label
              htmlFor="number"
