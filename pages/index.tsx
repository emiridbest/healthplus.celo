    ...
    <main>
      ...
      {componentInitialized && address ? (
        <div className="flex flex-col mx-auto content-center">
          ...
          <p className="flex flex-col mx-auto content-center">{address}</p>
          <button
            type="button"
          ...
          <div className={`flex flex-col resr-cyan mx-auto content-center px-4 py-5 text-center sm:px-6 ${showAnimation ? 'animate-bounce' : ''}`}>
            <h1 className="text-7xl font-bold text-cyan "> Health Plus Clinic</h1>
          </div>
          <h2 className="text-4xl font-bold ">Welcome to the World of Decentralised Health Care Management</h2>
